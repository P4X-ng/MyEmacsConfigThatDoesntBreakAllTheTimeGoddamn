...
Quick reference for the key bindings defined in `init.el`. Press `F2` or `C-c ?` inside Emacs at any time to show this list from within the editor.
...
## 💡 Help & Discovery
- `F2` or `C-c ?` — Show this cheat sheet
- `C-h k` — Describe key
